...
def main(args):
    ...
    # for env_name in args.env_name:
        ...
        #     continue
    x_norm, actor_network = torch.load('/Users/reedpan/Downloads/best.pt', map_location=lambda storage, loc: storage)
    actor_network.eval()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--env_name', type=str, default='PandaRearrangeBimanual-v0')
    # parser.add_argument('--run_tag', type=str)
    # parser.add_argument('--run_path', type=str, args='+')
